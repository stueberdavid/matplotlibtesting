...
#--------------------------------------------------
# PID überschreiben um Children besser zu verstehen
#--------------------------------------------------
...
def get_cpu_usage(pid):
    try:
        ...
        with open(stat_file, 'r') as f:
            ...
            utime = int(stat_values[15])  # 16. Wert (Index 13 in Python)
            stime = int(stat_values[16])  # 17. Wert (Index 14 in Python)
...
with open(LOG_FILE, 'w') as log_file:
    ...
    try:
        while True:
            ...
            cpu_usage = get_cpu_usage(script_PID)  # PID übergeben
